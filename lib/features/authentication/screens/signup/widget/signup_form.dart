...
import 'package:e_commerce_app/features/authentication/screens/signup/widget/terms_and_conditions.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      ...
      children: [
        ...
        FormDivider(isDark: isDark, txt: TTexts.orSignUpWith.capitalize!),
        const SizedBox(
          height: TSizes.spaceBtwSections,
        ),
        const SocialButton()
